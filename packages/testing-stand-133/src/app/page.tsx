...
export default function PacManGame() {
  ...
  useEffect(() => {
    ...
    ghostsRef.current.forEach((ghost, i) => {
      ...
      // Ghost eyes
      ctx.fillStyle = '#fff';
      ctx.fillRect(ghost.x * CELL_SIZE + 5, ghost.y * CELL_SIZE + 8, 4, 6);
      ctx.fillRect(ghost.x * CELL_SIZE + 11, ghost.y * CELL_SIZE + 8, 4, 6);
      ctx.fillStyle = '#000';
      ctx.fillRect(ghost.x * CELL_SIZE + 6, ghost.y * CELL_SIZE + 10, 2, 3);
      ctx.fillRect(ghost.x * CELL_SIZE + 12, ghost.y * CELL_SIZE + 10, 2, 3);
    });
  });
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4">
      ...
      {gameOver && (
        <div className="text-center">
          <p className="text-2xl mb-2 text-red-500">Game Over!</p>
